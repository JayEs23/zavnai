  ...
  return (
    <div className="max-w-2xl mx-auto space-y-12 py-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-[var(--muted-foreground)] text-lg font-medium">Experience full access to ZAVN free for 7 days.</p>
      </div>

      <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-10 space-y-10 shadow-lg relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8 opacity-10">
          <MdPayments size={120} className="text-[var(--primary)]" />
        </div>
        ...
        <div className="relative pl-12 space-y-12">
          ...
          <div className="relative group">
            <div className="absolute -left-[35px] bg-[var(--primary)] rounded-full p-1.5 shadow-lg shadow-[var(--primary)]/20 transition-transform group-hover:scale-110">
        ...
        <div className="pt-4 space-y-6">
          <button
            onClick={onNext}
            className="w-full btn-onboarding-primary py-5 rounded-2xl font-bold text-xl active:scale-95 transition-all"
          >
            Activate My Journey
          </button>
          <p className="text-center text-xs font-bold uppercase tracking-widest text-[var(--muted-foreground)] flex items-center justify-center gap-2">
            <MdLock size={14} className="text-[var(--primary)]" /> <span>Secure Checkout • Cancel Anytime</span>
          </p>
        </div>
      </div>
    </div>
